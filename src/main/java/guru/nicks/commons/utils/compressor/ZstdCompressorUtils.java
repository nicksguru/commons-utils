...
public class ZstdCompressorUtils {
     ...
     */
    public static final int MAX_DECOMPRESSED_SIZE = 50 * (int) FileUtils.ONE_MB;
    ...
    /**
     * Decompresses a Zstd frame, allocating exactly the frame's declared content size. Frames produced by
     * {@link #compress(byte[])} embed the content size, so they take the exact-allocation fast path.
     *
