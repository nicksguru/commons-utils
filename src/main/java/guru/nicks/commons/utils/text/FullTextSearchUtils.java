...
public class FullTextSearchUtils {
    ...
    /**
     * Collects full-text search data from the suppliers in a single pass, appending each kept value to a builder
     ...
     */
    public static FullTextSearchData collectFullTextSearchData(Collection<Supplier<String>> suppliers) {
     ...
     *                                  compatibility)
     */
    public static String buildFullTextSearchData(StringBuilder source, NgramUtilsConfig config, int maxLength) {
     ...
     */
    private static boolean appendFullTextSearchChunk(StringBuilder builder, String chunk, int maxLength) {
     ...
     */
    public record FullTextSearchData(
