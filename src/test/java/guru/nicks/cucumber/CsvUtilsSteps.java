...
import guru.nicks.utils.CsvUtils;
...
public class CsvUtilsSteps {
    ...
    public void parsedCsvShouldBe(String firstName1, String lastName1, Integer age1,
        ...
        assertThat(csvUtilsWorld.getParsed().get(0).getFirstName())
                .as("first record firstName")
                .isEqualTo(firstName1);

        assertThat(csvUtilsWorld.getParsed().get(0).getLastName())
                .as("first record lastName")
                .isEqualTo(lastName1);

        assertThat(csvUtilsWorld.getParsed().get(0).getAge())
                .as("first record age")
                .isEqualTo(age1);
